...
python scripts/postprocessing/estimate_flexibility_needs.py --output-dir build_postprocess --scenarios base_R2050 \
    --scenarios EVN_R2050 \
    --scenarios HPN_R2050 \
    --scenarios TPN_R2050 \
    --scenarios ELN_R2050 \
    --scenarios HSNSSN_R2050 \
    --scenarios HSN_R2050 \
    --scenarios SSN_R2050 \
    --scenarios EIN_R2050 \
    --scenarios DCN_R2050 \
...
python scripts/postprocessing/plot_flexibility_needs.py --output-dir build_postprocess
