...
### -- set the job Name --
#SBATCH --job-name=GREAT_fullyear_2030
...
#SBATCH --output=../logs/GREAT_fullyear_2030_%j.out
#SBATCH --error=../logs/GREAT_fullyear_2030_%j.err
...
gams Balmorel threads=$SLURM_CPUS_PER_TASK --USEOPTIONFILE=2 --scenario_name="${run_name}_F2030" $opts
cd ..

optimality_check $SLURM_JOB_ID 1

# Submit rolling horizon run
sbatch ../jobs/slurm/rolling_2030.sh
